...
class Hparams:
    ...
    parser.add_argument('--checkpoints_dir', default="models/v1.1.0", help="log directory")
    parser.add_argument('--num_epochs', default=200, type=int)
    parser.add_argument('--evaldir', default="models/v1.1.0_eval", help="evaluation dir")
    ...
    parser.add_argument('--testdir', default="models/v1.1.0_test", help="test result dir")
