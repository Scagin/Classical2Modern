...
class Hparams:
    ...
    parser.add_argument('--checkpoints_dir', default="models/v1.1.1", help="log directory")
    parser.add_argument('--num_epochs', default=50, type=int)
    parser.add_argument('--evaldir', default="models/v1.1.1_eval", help="evaluation dir")
    ...
    parser.add_argument('--maxlen1', default=40, type=int, help="maximum length of a source sequence")
    parser.add_argument('--maxlen2', default=60, type=int, help="maximum length of a target sequence")
    ...
    parser.add_argument('--testdir', default="models/v1.1.1_test", help="test result dir")
